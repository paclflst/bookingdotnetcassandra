...
namespace BookingService.Helper_Code.OAuth2
{
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        /// </summary>  
        private UserDAO databaseManager = new UserDAO();//new Oauth_APIEntities();
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var user = databaseManager.LoginByUsernamePassword(usernameVal, passwordVal).ToList();
